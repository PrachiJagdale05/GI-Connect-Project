...
app.post("/chat", async (req, res) => {
  try {
    ...
    // ✅ Inline instruction (no "system" role)
    const instruction = `You are GI Connect's official chatbot. The current user role is "${role}". 
Answer clearly and concisely. If database context is provided, use it in your answer.`;
    ...
    return res.json({ reply: aiReply, user_id, role });
  } catch (err) {
