...
/**
 * Normalize the service account key JSON from env.
 * Handles both base64 and raw JSON formats.
 */
...
/**
 * Build JWT and exchange for Google OAuth2 access token
 */
