...
/**
 * Normalize env key so it works whether stored raw or base64/escaped.
 */
...
/**
 * Generate access token for BigQuery using service account JWT.
 */
...
serve(async (req) => {
  try {
    ...
    // TODO: update with your dataset & table names
